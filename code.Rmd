...
texreg::htmlreg(
  ...
  custom.coef.map = list(
    "pop_density_int" = "Pop. Density",
    "ntile(pop_white, 4)" = "% White (Quartiles)",
    "log(median_income)" = "Income (log)",
    "log(train_dist)" = "Distance to Train (log)",
    "log(bus_dist)" = "Distance to Bus (log)",
    "log(cost_sqft)" = "Cost per sq.ft. (log)",
    "overall_cond" = "Building Condition",
    "own_occ" = "Owner Occupied",
    "yr_built" = "Year Built",
    "(Intercept)" = "Constant"
...
ggsave(gg, filename = "viz/crossbars.png", dpi = 500, width = 7, height = 7)
```
